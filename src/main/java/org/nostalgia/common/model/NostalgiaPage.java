...
public class NostalgiaPage<R> {
     ...
     */
    public static <E, C> NostalgiaPage<C> of(final Page<E> pageableEntities,
                                             final List<C> content) {

        final var responseBuilder = NostalgiaPage.<C>builder()
                .content(content)
        ...
        if (pageableEntities.getSort().isSorted()) {
            responseBuilder.orderedBy(NostalgiaSort.of(pageableEntities.getSort()).getOrders());
        }
     ...
     * @return The paginated response.
     */
    public static <E, C> NostalgiaPage<C> of(final NostalgiaFilter filter,
