 ...
 */
public class NostalgiaAdminRegistrationApplicationAlreadyApprovedException extends AysAlreadyException {
     ...
     */
    public NostalgiaAdminRegistrationApplicationAlreadyApprovedException(final String id,
