 ...
 */
public class NostalgiaAdminRegistrationApplicationInCompleteException extends AysBadRequestException {
    ...
    /**
     * Constructs a new {@link NostalgiaAdminRegistrationApplicationInCompleteException} with the specified applicationId and applicationStatus.
     *
     ...
     */
    public NostalgiaAdminRegistrationApplicationInCompleteException(final String id,
